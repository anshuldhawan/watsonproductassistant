---
name: interleaving-experiments
description: "Runs the Lighthouse Interleaving Recommendation Tests analysis for A/B Testing & Experimentation. Use when the analyst is asked to run `interleaving-experiments` or investigate fast evaluation of recommendations algorithm variations by presenting combined listings directly to users."
---

# Skill: Interleaving Recommendation Tests

## Identity

- Skill key: `interleaving-experiments`
...
Use this skill when the user selects `interleaving-experiments` or asks for: Fast evaluation of recommendations algorithm variations by presenting combined listings directly to users.
