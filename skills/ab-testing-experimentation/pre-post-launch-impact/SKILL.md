---
name: pre-post-launch-impact
description: "Runs the Lighthouse Pre-Post Launch Impact Analysis analysis for A/B Testing & Experimentation. Use when the analyst is asked to run `pre-post-launch-impact` or investigate use difference-in-differences or synthetic control methods to evaluate features rolled out without an A/B test."
---

# Skill: Pre-Post Launch Impact Analysis

## Identity

- Skill key: `pre-post-launch-impact`
- Group: `ab-testing-experimentation` (A/B Testing & Experimentation)
- Owning agent: `experimentation-analyst`
- Primary metric hint: `pre_post_launch_impact_index`

## When To Use

Use this skill when the user selects `pre-post-launch-impact` or asks for: Use difference-in-differences or synthetic control methods to evaluate features rolled out without an A/B test.
