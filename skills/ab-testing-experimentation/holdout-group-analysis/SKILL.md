---
name: holdout-group-analysis
description: "Runs the Lighthouse Long-term Holdout Group Analysis analysis for A/B Testing & Experimentation. Use when the analyst is asked to run `holdout-group-analysis` or investigate examine macro-effects of UI features withheld from a control cohort for months (e.g., ad density changes)."
---

# Skill: Long-term Holdout Group Analysis

## Identity

- Skill key: `holdout-group-analysis`
- Group: `ab-testing-experimentation` (A/B Testing & Experimentation)
- Owning agent: `experimentation-analyst`
- Primary metric hint: `holdout_group_analysis_index`

## When To Use

Use this skill when the user selects `holdout-group-analysis` or asks for: Examine macro-effects of UI features withheld from a control cohort for months (e.g., ad density changes).
