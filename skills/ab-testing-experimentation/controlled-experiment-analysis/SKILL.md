---
name: controlled-experiment-analysis
description: "Runs the Lighthouse Controlled Experiment (A/B Test) Analysis analysis for A/B Testing & Experimentation. Use when the analyst is asked to run `controlled-experiment-analysis` or investigate evaluate test variant performance using t-tests and chi-squared tests to calculate statistical significance."
---

# Skill: Controlled Experiment (A/B Test) Analysis

## Identity

- Skill key: `controlled-experiment-analysis`
- Group: `ab-testing-experimentation` (A/B Testing & Experimentation)
- Owning agent: `experimentation-analyst`
- Primary metric hint: `variant_lift`

## When To Use

Use this skill when the user selects `controlled-experiment-analysis` or asks for: Evaluate test variant performance using t-tests and chi-squared tests to calculate statistical significance.
