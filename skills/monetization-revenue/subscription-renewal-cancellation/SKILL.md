---
name: subscription-renewal-cancellation
description: "Runs the Lighthouse Subscription Renewal & Cancellation Patterns analysis for Monetization & Revenue. Use when the analyst is asked to run `subscription-renewal-cancellation` or investigate examine payment failures, churn notices, and cancellation survey inputs to locate exit drivers."
---

# Skill: Subscription Renewal & Cancellation Patterns

## Identity

- Skill key: `subscription-renewal-cancellation`
- Group: `monetization-revenue` (Monetization & Revenue)
- Owning agent: `monetization-analyst`
- Primary metric hint: `subscription_renewal_cancellation_index`

## When To Use

Use this skill when the user selects `subscription-renewal-cancellation` or asks for: Examine payment failures, churn notices, and cancellation survey inputs to locate exit drivers.
