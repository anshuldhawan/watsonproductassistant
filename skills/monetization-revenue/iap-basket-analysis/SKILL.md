---
name: iap-basket-analysis
description: "Runs the Lighthouse In-App Purchases Basket Analysis analysis for Monetization & Revenue. Use when the analyst is asked to run `iap-basket-analysis` or investigate examine correlation between multiple add-on services or virtual items bought together."
---

# Skill: In-App Purchases Basket Analysis

## Identity

- Skill key: `iap-basket-analysis`
...
Use this skill when the user selects `iap-basket-analysis` or asks for: Examine correlation between multiple add-on services or virtual items bought together.
