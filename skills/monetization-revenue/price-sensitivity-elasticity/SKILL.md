---
name: price-sensitivity-elasticity
description: "Runs the Lighthouse Price Sensitivity & Elasticity Modeling analysis for Monetization & Revenue. Use when the analyst is asked to run `price-sensitivity-elasticity` or investigate observe subscription upgrade rates across different geographic pricing brackets."
---

# Skill: Price Sensitivity & Elasticity Modeling

## Identity

- Skill key: `price-sensitivity-elasticity`
- Group: `monetization-revenue` (Monetization & Revenue)
- Owning agent: `monetization-analyst`
- Primary metric hint: `price_sensitivity_elasticity_index`

## When To Use

Use this skill when the user selects `price-sensitivity-elasticity` or asks for: Observe subscription upgrade rates across different geographic pricing brackets.
