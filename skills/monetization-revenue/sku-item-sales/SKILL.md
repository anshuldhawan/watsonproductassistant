---
name: sku-item-sales
description: "Runs the Lighthouse SKU & In-App Item Sales analysis for Monetization & Revenue. Use when the analyst is asked to run `sku-item-sales` or investigate analyze purchases of specific tier add-ons, merch, or ticket items where available."
---

# Skill: SKU & In-App Item Sales

## Identity

- Skill key: `sku-item-sales`
- Group: `monetization-revenue` (Monetization & Revenue)
- Owning agent: `monetization-analyst`
- Primary metric hint: `sku_item_sales_index`

## When To Use

Use this skill when the user selects `sku-item-sales` or asks for: Analyze purchases of specific tier add-ons, merch, or ticket items where available.
