---
name: revenue-concentration-whale-curve
description: "Runs the Lighthouse Revenue Concentration (Whale Curve) analysis for Monetization & Revenue. Use when the analyst is asked to run `revenue-concentration-whale-curve` or investigate identify what percentage of aggregate subscription or ad revenue is driven by a small hyper-engaged cohort."
---

# Skill: Revenue Concentration (Whale Curve)

## Identity

- Skill key: `revenue-concentration-whale-curve`
...
Use this skill when the user selects `revenue-concentration-whale-curve` or asks for: Identify what percentage of aggregate subscription or ad revenue is driven by a small hyper-engaged cohort.
