---
name: ltv-to-cac-by-channel
description: "Runs the Lighthouse LTV-to-CAC Ratio by Acquisition Channel analysis for Monetization & Revenue. Use when the analyst is asked to run `ltv-to-cac-by-channel` or investigate compare customer acquisition cost against customer lifetime value across social, search, and referral sources."
---

# Skill: LTV-to-CAC Ratio by Acquisition Channel

## Identity

- Skill key: `ltv-to-cac-by-channel`
...
Use this skill when the user selects `ltv-to-cac-by-channel` or asks for: Compare customer acquisition cost against customer lifetime value across social, search, and referral sources.
