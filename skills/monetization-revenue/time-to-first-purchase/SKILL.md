...
description: "Runs the Lighthouse Time-to-First-Purchase Duration analysis for Monetization & Revenue. Use when the analyst is asked to run `time-to-first-purchase` or investigate how long does a free tier user wait before upgrading to premium subscription?"
---

# Skill: Time-to-First-Purchase Duration

## Identity

- Skill key: `time-to-first-purchase`
...
Use this skill when the user selects `time-to-first-purchase` or asks for: How long does a free tier user wait before upgrading to premium subscription?
