---
name: conversion-to-payer-funnel
description: "Runs the Lighthouse Conversion-to-Payer Funnel analysis for Monetization & Revenue. Use when the analyst is asked to run `conversion-to-payer-funnel` or investigate trace the path from free sign-up to premium subscription purchase to optimize pricing gates."
---

# Skill: Conversion-to-Payer Funnel

## Identity

- Skill key: `conversion-to-payer-funnel`
...
Use this skill when the user selects `conversion-to-payer-funnel` or asks for: Trace the path from free sign-up to premium subscription purchase to optimize pricing gates.
