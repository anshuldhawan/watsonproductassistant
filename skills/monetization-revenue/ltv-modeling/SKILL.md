---
name: ltv-modeling
description: "Runs the Lighthouse Lifetime Value (LTV) Modeling analysis for Monetization & Revenue. Use when the analyst is asked to run `ltv-modeling` or investigate predict the long-term cumulative net revenue generated by an average user cohort."
---

# Skill: Lifetime Value (LTV) Modeling

## Identity

- Skill key: `ltv-modeling`
...
Use this skill when the user selects `ltv-modeling` or asks for: Predict the long-term cumulative net revenue generated by an average user cohort.
