...
description: "Runs the Lighthouse Trial-to-Paid Conversion Optimization analysis for Monetization & Revenue. Use when the analyst is asked to run `trial-to-paid-conversion` or investigate analyze the conversion rate of 7-day or 30-day premium free trials into paying subscriptions."
---

# Skill: Trial-to-Paid Conversion Optimization

## Identity

- Skill key: `trial-to-paid-conversion`
...
Use this skill when the user selects `trial-to-paid-conversion` or asks for: Analyze the conversion rate of 7-day or 30-day premium free trials into paying subscriptions.
