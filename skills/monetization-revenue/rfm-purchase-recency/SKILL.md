---
name: rfm-purchase-recency
description: "Runs the Lighthouse Recency, Frequency, Monetary (RFM) Purchase Analysis analysis for Monetization & Revenue. Use when the analyst is asked to run `rfm-purchase-recency` or investigate segment payers by purchasing behavior to target promotional discount offerings."
---

# Skill: Recency, Frequency, Monetary (RFM) Purchase Analysis

## Identity

- Skill key: `rfm-purchase-recency`
...
Use this skill when the user selects `rfm-purchase-recency` or asks for: Segment payers by purchasing behavior to target promotional discount offerings.
