---
name: loot-reward-distribution
description: "Runs the Lighthouse Daily Reward & Badge Engagement analysis for Content & Game Economy. Use when the analyst is asked to run `loot-reward-distribution` or investigate examine click-through and return rates on daily discovery badges (e.g., 'Early Listener')."
---

# Skill: Daily Reward & Badge Engagement

## Identity

- Skill key: `loot-reward-distribution`
...
Use this skill when the user selects `loot-reward-distribution` or asks for: Examine click-through and return rates on daily discovery badges (e.g., 'Early Listener').
