---
name: onboarding-completion-dropoff
description: "Runs the Lighthouse Onboarding Completion Drop-off analysis for Acquisition & Onboarding. Use when the analyst is asked to run `onboarding-completion-dropoff` or investigate identify where users abandon the onboarding flow prior to first music play."
---

# Skill: Onboarding Completion Drop-off

## Identity

- Skill key: `onboarding-completion-dropoff`
- Group: `acquisition-onboarding` (Acquisition & Onboarding)
- Owning agent: `acquisition-analyst`
- Primary metric hint: `onboarding_completion_dropoff_index`

## When To Use

Use this skill when the user selects `onboarding-completion-dropoff` or asks for: Identify where users abandon the onboarding flow prior to first music play.
