---
name: ftue-funnel
description: "Runs the Lighthouse First-Time User Experience (FTUE) Funnel analysis for Acquisition & Onboarding. Use when the analyst is asked to run `ftue-funnel` or investigate step-by-step funnel analysis of the very first session to locate setup bottlenecks."
---

# Skill: First-Time User Experience (FTUE) Funnel

## Identity

- Skill key: `ftue-funnel`
...
Use this skill when the user selects `ftue-funnel` or asks for: Step-by-step funnel analysis of the very first session to locate setup bottlenecks.
