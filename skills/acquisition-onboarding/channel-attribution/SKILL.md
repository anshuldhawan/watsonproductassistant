...
description: "Runs the Lighthouse Channel Attribution Analysis analysis for Acquisition & Onboarding. Use when the analyst is asked to run `channel-attribution` or investigate determine which marketing and signup channels drive the highest quality users."
---

# Skill: Channel Attribution Analysis

## Identity

- Skill key: `channel-attribution`
- Group: `acquisition-onboarding` (Acquisition & Onboarding)
- Owning agent: `acquisition-analyst`
- Primary metric hint: `channel_attribution_index`

## When To Use

Use this skill when the user selects `channel-attribution` or asks for: Determine which marketing and signup channels drive the highest quality users.
