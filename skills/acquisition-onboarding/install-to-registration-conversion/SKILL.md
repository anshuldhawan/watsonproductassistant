---
name: install-to-registration-conversion
description: "Runs the Lighthouse Install-to-Registration Conversion analysis for Acquisition & Onboarding. Use when the analyst is asked to run `install-to-registration-conversion` or investigate measure friction and drop-off rates between initial app load and successful user registration."
---

# Skill: Install-to-Registration Conversion

## Identity

- Skill key: `install-to-registration-conversion`
...
Use this skill when the user selects `install-to-registration-conversion` or asks for: Measure friction and drop-off rates between initial app load and successful user registration.
