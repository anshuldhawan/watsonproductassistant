...
description: "Runs the Lighthouse Subscription Purchase Propensity Modeling analysis for Predictive Modelling. Use when the analyst is asked to run `propensity-to-purchase` or investigate score active free users by their upgrade likelihood to optimize targeting of paywall discount campaigns."
---

# Skill: Subscription Purchase Propensity Modeling

## Identity

- Skill key: `propensity-to-purchase`
...
Use this skill when the user selects `propensity-to-purchase` or asks for: Score active free users by their upgrade likelihood to optimize targeting of paywall discount campaigns.
