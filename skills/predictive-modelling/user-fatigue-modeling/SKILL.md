---
name: user-fatigue-modeling
description: "Runs the Lighthouse Ad & Push Fatigue Modeling analysis for Predictive Modelling. Use when the analyst is asked to run `user-fatigue-modeling` or investigate predict threshold of ad frequency or push notifications that trigger app uninstallation."
---

# Skill: Ad & Push Fatigue Modeling

## Identity

- Skill key: `user-fatigue-modeling`
- Group: `predictive-modelling` (Predictive Modelling)
- Owning agent: `predictive-analyst`
- Primary metric hint: `user_fatigue_modeling_index`

## When To Use

Use this skill when the user selects `user-fatigue-modeling` or asks for: Predict threshold of ad frequency or push notifications that trigger app uninstallation.
