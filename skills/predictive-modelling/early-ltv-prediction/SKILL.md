---
name: early-ltv-prediction
description: "Runs the Lighthouse Day-7 Customer Lifetime Value Prediction analysis for Predictive Modelling. Use when the analyst is asked to run `early-ltv-prediction` or investigate predict a user's 365-day LTV based on their initial 7 days of active listening patterns."
---

# Skill: Day-7 Customer Lifetime Value Prediction

## Identity

- Skill key: `early-ltv-prediction`
...
Use this skill when the user selects `early-ltv-prediction` or asks for: Predict a user's 365-day LTV based on their initial 7 days of active listening patterns.
