---
name: anomaly-detection-kpi
description: "Runs the Lighthouse KPI Anomaly Detection & Volatility Alerts analysis for Predictive Modelling. Use when the analyst is asked to run `anomaly-detection-kpi` or investigate engine that monitors and flags statistical trend breaks or spikes in core subscription or active cohorts."
---

# Skill: KPI Anomaly Detection & Volatility Alerts

## Identity

- Skill key: `anomaly-detection-kpi`
- Group: `predictive-modelling` (Predictive Modelling)
- Owning agent: `predictive-analyst`
- Primary metric hint: `kpi_deviation`

## When To Use

Use this skill when the user selects `anomaly-detection-kpi` or asks for: Engine that monitors and flags statistical trend breaks or spikes in core subscription or active cohorts.
