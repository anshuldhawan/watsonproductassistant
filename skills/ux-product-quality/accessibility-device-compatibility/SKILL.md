---
name: accessibility-device-compatibility
description: "Runs the Lighthouse Device & Operating System Compatibility analysis for UX & Product Quality. Use when the analyst is asked to run `accessibility-device-compatibility` or investigate flag performance drops (crashes, latency, dropouts) on specific mobile device architectures."
---

# Skill: Device & Operating System Compatibility

## Identity

- Skill key: `accessibility-device-compatibility`
- Group: `ux-product-quality` (UX & Product Quality)
- Owning agent: `ux-quality-analyst`
- Primary metric hint: `accessibility_device_compatibility_index`

## When To Use

Use this skill when the user selects `accessibility-device-compatibility` or asks for: Flag performance drops (crashes, latency, dropouts) on specific mobile device architectures.
