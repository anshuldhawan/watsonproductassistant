---
name: heatmaps-scroll-maps
description: "Runs the Lighthouse UX Heatmaps & Scroll-depth Analytics analysis for UX & Product Quality. Use when the analyst is asked to run `heatmaps-scroll-maps` or investigate evaluate user scrolling and clicking patterns inside the home screen feed layout."
---

# Skill: UX Heatmaps & Scroll-depth Analytics

## Identity

- Skill key: `heatmaps-scroll-maps`
- Group: `ux-product-quality` (UX & Product Quality)
- Owning agent: `ux-quality-analyst`
- Primary metric hint: `heatmaps_scroll_maps_index`

## When To Use

Use this skill when the user selects `heatmaps-scroll-maps` or asks for: Evaluate user scrolling and clicking patterns inside the home screen feed layout.
