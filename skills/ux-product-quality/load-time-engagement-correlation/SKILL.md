---
name: load-time-engagement-correlation
description: "Runs the Lighthouse App Load Time vs. Engagement analysis for UX & Product Quality. Use when the analyst is asked to run `load-time-engagement-correlation` or investigate quantify retention and session depth decay as app startup or track loading latency increases."
---

# Skill: App Load Time vs. Engagement

## Identity

- Skill key: `load-time-engagement-correlation`
...
Use this skill when the user selects `load-time-engagement-correlation` or asks for: Quantify retention and session depth decay as app startup or track loading latency increases.
