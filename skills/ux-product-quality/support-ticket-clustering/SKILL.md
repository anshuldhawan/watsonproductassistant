...
description: "Runs the Lighthouse Support Ticket NLP Clustering analysis for UX & Product Quality. Use when the analyst is asked to run `support-ticket-clustering` or investigate group incoming customer service requests to highlight immediate product defects."
---

# Skill: Support Ticket NLP Clustering

## Identity

- Skill key: `support-ticket-clustering`
- Group: `ux-product-quality` (UX & Product Quality)
- Owning agent: `ux-quality-analyst`
- Primary metric hint: `support_ticket_clustering_index`

## When To Use

Use this skill when the user selects `support-ticket-clustering` or asks for: Group incoming customer service requests to highlight immediate product defects.
