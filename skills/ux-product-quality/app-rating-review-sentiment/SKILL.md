---
name: app-rating-review-sentiment
description: "Runs the Lighthouse App Store Review Sentiment Integration analysis for UX & Product Quality. Use when the analyst is asked to run `app-rating-review-sentiment` or investigate ingest and analyze negative app store ratings to highlight UX pain points."
---

# Skill: App Store Review Sentiment Integration

## Identity

- Skill key: `app-rating-review-sentiment`
...
Use this skill when the user selects `app-rating-review-sentiment` or asks for: Ingest and analyze negative app store ratings to highlight UX pain points.
