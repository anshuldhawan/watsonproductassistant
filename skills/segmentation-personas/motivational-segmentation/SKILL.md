---
name: motivational-segmentation
description: "Runs the Lighthouse Motivational Segment Profiling analysis for Segmentation & Personas. Use when the analyst is asked to run `motivational-segmentation` or investigate group users based on core music utilities: Social Sharers, Background Listeners, Hardcore Collectors."
---

# Skill: Motivational Segment Profiling

## Identity

- Skill key: `motivational-segmentation`
- Group: `segmentation-personas` (Segmentation & Personas)
- Owning agent: `segmentation-analyst`
- Primary metric hint: `motivational_segmentation_index`

## When To Use

Use this skill when the user selects `motivational-segmentation` or asks for: Group users based on core music utilities: Social Sharers, Background Listeners, Hardcore Collectors.
