---
name: high-value-user-profiling
description: "Runs the Lighthouse High-Value User Profiling analysis for Segmentation & Personas. Use when the analyst is asked to run `high-value-user-profiling` or investigate examine common acquisition paths, demographic profiles, and taste metrics of the top 5% of paying users."
---

# Skill: High-Value User Profiling

## Identity

- Skill key: `high-value-user-profiling`
- Group: `segmentation-personas` (Segmentation & Personas)
- Owning agent: `segmentation-analyst`
- Primary metric hint: `high_value_user_profiling_index`

## When To Use

Use this skill when the user selects `high-value-user-profiling` or asks for: Examine common acquisition paths, demographic profiles, and taste metrics of the top 5% of paying users.
