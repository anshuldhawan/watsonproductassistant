...
description: "Runs the Lighthouse Genre-Taste Profile Mapping analysis for Segmentation & Personas. Use when the analyst is asked to run `psychographic-segmentation` or investigate deduce underlying user mood profiles (Chill, Party, Focused, High Energy) based on track acoustic tags."
---

# Skill: Genre-Taste Profile Mapping

## Identity

- Skill key: `psychographic-segmentation`
- Group: `segmentation-personas` (Segmentation & Personas)
- Owning agent: `segmentation-analyst`
- Primary metric hint: `psychographic_segmentation_index`

## When To Use

Use this skill when the user selects `psychographic-segmentation` or asks for: Deduce underlying user mood profiles (Chill, Party, Focused, High Energy) based on track acoustic tags.
