---
name: lifecycle-stage-segmentation
description: "Runs the Lighthouse User Lifecycle Stage Analysis analysis for Segmentation & Personas. Use when the analyst is asked to run `lifecycle-stage-segmentation` or investigate profile users by active months: Newbies, Retained Steady, Churn-risk, Reactivated."
---

# Skill: User Lifecycle Stage Analysis

## Identity

- Skill key: `lifecycle-stage-segmentation`
- Group: `segmentation-personas` (Segmentation & Personas)
- Owning agent: `segmentation-analyst`
- Primary metric hint: `lifecycle_stage_segmentation_index`

## When To Use

Use this skill when the user selects `lifecycle-stage-segmentation` or asks for: Profile users by active months: Newbies, Retained Steady, Churn-risk, Reactivated.
