...
description: "Runs the Lighthouse Behavioral Clustering Analysis analysis for Segmentation & Personas. Use when the analyst is asked to run `behavioral-clustering` or investigate apply unsupervised clustering to segment users by musical taste, skip behavior, and time of day."
---

# Skill: Behavioral Clustering Analysis

## Identity

- Skill key: `behavioral-clustering`
- Group: `segmentation-personas` (Segmentation & Personas)
- Owning agent: `segmentation-analyst`
- Primary metric hint: `behavioral_clustering_index`

## When To Use

Use this skill when the user selects `behavioral-clustering` or asks for: Apply unsupervised clustering to segment users by musical taste, skip behavior, and time of day.
