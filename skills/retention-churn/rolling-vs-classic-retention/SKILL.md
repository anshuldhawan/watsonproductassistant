---
name: rolling-vs-classic-retention
description: "Runs the Lighthouse Rolling vs. Classic Retention analysis for Retention & Churn. Use when the analyst is asked to run `rolling-vs-classic-retention` or investigate compare strict day-N retention vs. rolling active calculations for better baseline metrics."
---

# Skill: Rolling vs. Classic Retention

## Identity

- Skill key: `rolling-vs-classic-retention`
...
Use this skill when the user selects `rolling-vs-classic-retention` or asks for: Compare strict day-N retention vs. rolling active calculations for better baseline metrics.
