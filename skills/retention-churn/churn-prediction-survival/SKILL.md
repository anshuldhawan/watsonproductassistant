---
name: churn-prediction-survival
description: "Runs the Lighthouse Churn Prediction & Survival Analysis analysis for Retention & Churn. Use when the analyst is asked to run `churn-prediction-survival` or investigate model user lifecycle decay curves to estimate probability of user churn over time."
---

# Skill: Churn Prediction & Survival Analysis

## Identity

- Skill key: `churn-prediction-survival`
...
Use this skill when the user selects `churn-prediction-survival` or asks for: Model user lifecycle decay curves to estimate probability of user churn over time.
