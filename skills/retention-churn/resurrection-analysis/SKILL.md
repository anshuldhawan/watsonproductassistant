---
name: resurrection-analysis
description: "Runs the Lighthouse Resurrected User Analysis analysis for Retention & Churn. Use when the analyst is asked to run `resurrection-analysis` or investigate evaluate why lapsed users return and what actions (push alerts, emails, friends) brought them back."
---

# Skill: Resurrected User Analysis

## Identity

- Skill key: `resurrection-analysis`
- Group: `retention-churn` (Retention & Churn)
- Owning agent: `retention-analyst`
- Primary metric hint: `resurrection_analysis_index`

## When To Use

Use this skill when the user selects `resurrection-analysis` or asks for: Evaluate why lapsed users return and what actions (push alerts, emails, friends) brought them back.
