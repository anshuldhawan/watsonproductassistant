...
description: "Runs the Lighthouse Cohort Retention Curves analysis for Retention & Churn. Use when the analyst is asked to run `cohort-retention-curves` or investigate plot daily, weekly, and monthly active user retention curves for tracking cohort health."
---
...
- Skill key: `cohort-retention-curves`
...
Use this skill when the user selects `cohort-retention-curves` or asks for: Plot daily, weekly, and monthly active user retention curves for tracking cohort health.
