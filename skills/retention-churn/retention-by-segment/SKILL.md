...
description: "Runs the Lighthouse Retention by User Segment analysis for Retention & Churn. Use when the analyst is asked to run `retention-by-segment` or investigate compare retention curves across age groups, signup countries, genres, and subscription tiers."
---

# Skill: Retention by User Segment

## Identity

- Skill key: `retention-by-segment`
...
Use this skill when the user selects `retention-by-segment` or asks for: Compare retention curves across age groups, signup countries, genres, and subscription tiers.
