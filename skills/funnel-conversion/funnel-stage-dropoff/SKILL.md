---
name: funnel-stage-dropoff
description: "Runs the Lighthouse Funnel Stage Drop-off Metrics analysis for Funnel & Conversion. Use when the analyst is asked to run `funnel-stage-dropoff` or investigate examine the timing and triggers of funnel drops (app backgrounding, back clicks)."
---

# Skill: Funnel Stage Drop-off Metrics

## Identity

- Skill key: `funnel-stage-dropoff`
...
Use this skill when the user selects `funnel-stage-dropoff` or asks for: Examine the timing and triggers of funnel drops (app backgrounding, back clicks).
