---
name: funnel-comparison-by-segment
description: "Runs the Lighthouse Funnel Comparison by Segment analysis for Funnel & Conversion. Use when the analyst is asked to run `funnel-comparison-by-segment` or investigate compare checkout funnel performance across countries, devices, and genders."
---

# Skill: Funnel Comparison by Segment

## Identity

- Skill key: `funnel-comparison-by-segment`
...
Use this skill when the user selects `funnel-comparison-by-segment` or asks for: Compare checkout funnel performance across countries, devices, and genders.
