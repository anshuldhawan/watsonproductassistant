...
description: "Runs the Lighthouse Micro-Conversion Tracking analysis for Funnel & Conversion. Use when the analyst is asked to run `micro-conversion-tracking` or investigate analyze minor conversions (like clicking 'View Premium Plans') that predict subscription upgrade."
---

# Skill: Micro-Conversion Tracking

## Identity

- Skill key: `micro-conversion-tracking`
...
Use this skill when the user selects `micro-conversion-tracking` or asks for: Analyze minor conversions (like clicking 'View Premium Plans') that predict subscription upgrade.
