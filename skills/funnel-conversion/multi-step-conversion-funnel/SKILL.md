---
name: multi-step-conversion-funnel
description: "Runs the Lighthouse Multi-Step Conversion Funnel analysis for Funnel & Conversion. Use when the analyst is asked to run `multi-step-conversion-funnel` or investigate track multi-screen checkout processes to target friction zones and leaks."
---

# Skill: Multi-Step Conversion Funnel

## Identity

- Skill key: `multi-step-conversion-funnel`
...
Use this skill when the user selects `multi-step-conversion-funnel` or asks for: Track multi-screen checkout processes to target friction zones and leaks.
