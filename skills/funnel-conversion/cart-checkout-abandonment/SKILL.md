...
description: "Runs the Lighthouse Cart & Checkout Abandonment Analysis analysis for Funnel & Conversion. Use when the analyst is asked to run `cart-checkout-abandonment` or investigate drill down into users who entered the payment details screen but failed to click 'Pay Now'."
---

# Skill: Cart & Checkout Abandonment Analysis

## Identity

- Skill key: `cart-checkout-abandonment`
...
Use this skill when the user selects `cart-checkout-abandonment` or asks for: Drill down into users who entered the payment details screen but failed to click 'Pay Now'.
