---
name: in-app-survey-analysis
description: "Runs the Lighthouse In-App Micro-Survey NLP analysis for Feedback & Sentiment. Use when the analyst is asked to run `in-app-survey-analysis` or investigate analyze open-ended user feedback prompted immediately after specific actions (e.g. cancellation, downgrade)."
---

# Skill: In-App Micro-Survey NLP

## Identity

- Skill key: `in-app-survey-analysis`
- Group: `feedback-sentiment` (Feedback & Sentiment)
- Owning agent: `feedback-analyst`
- Primary metric hint: `sentiment_score`

## When To Use

Use this skill when the user selects `in-app-survey-analysis` or asks for: Analyze open-ended user feedback prompted immediately after specific actions (e.g. cancellation, downgrade).
