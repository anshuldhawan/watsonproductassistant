---
name: nps-csat-trends
description: "Runs the Lighthouse Net Promoter Score (NPS) & CSAT Trends analysis for Feedback & Sentiment. Use when the analyst is asked to run `nps-csat-trends` or investigate track quantitative customer satisfaction indicators and correlate them to active retention rates."
---

# Skill: Net Promoter Score (NPS) & CSAT Trends

## Identity

- Skill key: `nps-csat-trends`
...
Use this skill when the user selects `nps-csat-trends` or asks for: Track quantitative customer satisfaction indicators and correlate them to active retention rates.
