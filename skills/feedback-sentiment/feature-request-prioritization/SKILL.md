---
name: feature-request-prioritization
description: "Runs the Lighthouse Feature Request Impact Scoring analysis for Feedback & Sentiment. Use when the analyst is asked to run `feature-request-prioritization` or investigate rank requested items by matching requester user-profiles against total business value / paying metrics."
---

# Skill: Feature Request Impact Scoring

## Identity

- Skill key: `feature-request-prioritization`
- Group: `feedback-sentiment` (Feedback & Sentiment)
- Owning agent: `feedback-analyst`
- Primary metric hint: `feature_request_prioritization_index`

## When To Use

Use this skill when the user selects `feature-request-prioritization` or asks for: Rank requested items by matching requester user-profiles against total business value / paying metrics.
