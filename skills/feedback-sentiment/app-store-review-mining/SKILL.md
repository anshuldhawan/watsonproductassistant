---
name: app-store-review-mining
description: "Runs the Lighthouse App Store Review Competitor Mining analysis for Feedback & Sentiment. Use when the analyst is asked to run `app-store-review-mining` or investigate analyze review keywords of competitor music platforms to spot feature opportunities."
---

# Skill: App Store Review Competitor Mining

## Identity

- Skill key: `app-store-review-mining`
...
Use this skill when the user selects `app-store-review-mining` or asks for: Analyze review keywords of competitor music platforms to spot feature opportunities.
