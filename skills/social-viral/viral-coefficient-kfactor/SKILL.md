---
name: viral-coefficient-kfactor
description: "Runs the Lighthouse Viral Coefficient (K-Factor) Calculation analysis for Social & Viral. Use when the analyst is asked to run `viral-coefficient-kfactor` or investigate measure invitation loops and conversion rate of newly referred contacts."
---

# Skill: Viral Coefficient (K-Factor) Calculation

## Identity

- Skill key: `viral-coefficient-kfactor`
- Group: `social-viral` (Social & Viral)
- Owning agent: `social-viral-analyst`
- Primary metric hint: `viral_coefficient_kfactor_index`

## When To Use

Use this skill when the user selects `viral-coefficient-kfactor` or asks for: Measure invitation loops and conversion rate of newly referred contacts.
