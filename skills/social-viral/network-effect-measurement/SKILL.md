---
name: network-effect-measurement
description: "Runs the Lighthouse Network Effect Value Analysis analysis for Social & Viral. Use when the analyst is asked to run `network-effect-measurement` or investigate examine if users with connected active friends have higher retention and subscription probability."
---

# Skill: Network Effect Value Analysis

## Identity

- Skill key: `network-effect-measurement`
- Group: `social-viral` (Social & Viral)
- Owning agent: `social-viral-analyst`
- Primary metric hint: `network_effect_measurement_index`

## When To Use

Use this skill when the user selects `network-effect-measurement` or asks for: Examine if users with connected active friends have higher retention and subscription probability.
