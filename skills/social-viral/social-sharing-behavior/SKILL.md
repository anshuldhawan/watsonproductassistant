...
description: "Runs the Lighthouse Social Sharing & Story Actions analysis for Social & Viral. Use when the analyst is asked to run `social-sharing-behavior` or investigate analyze which songs or playlists are shared most to external apps (Instagram, WhatsApp) and subsequent referral traffic."
---

# Skill: Social Sharing & Story Actions

## Identity

- Skill key: `social-sharing-behavior`
- Group: `social-viral` (Social & Viral)
- Owning agent: `social-viral-analyst`
- Primary metric hint: `social_sharing_behavior_index`

## When To Use

Use this skill when the user selects `social-sharing-behavior` or asks for: Analyze which songs or playlists are shared most to external apps (Instagram, WhatsApp) and subsequent referral traffic.
