---
name: guild-clan-group-dynamics
description: "Runs the Lighthouse Shared Playlist Collaborators analysis for Social & Viral. Use when the analyst is asked to run `guild-clan-group-dynamics` or investigate analyze engagement trends inside collaborative, multi-user playlists."
---

# Skill: Shared Playlist Collaborators

## Identity

- Skill key: `guild-clan-group-dynamics`
- Group: `social-viral` (Social & Viral)
- Owning agent: `social-viral-analyst`
- Primary metric hint: `guild_clan_group_dynamics_index`

## When To Use

Use this skill when the user selects `guild-clan-group-dynamics` or asks for: Analyze engagement trends inside collaborative, multi-user playlists.
