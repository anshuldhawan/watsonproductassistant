---
name: peer-influence-contagion
description: "Runs the Lighthouse Social Contagion & Peer Influence analysis for Social & Viral. Use when the analyst is asked to run `peer-influence-contagion` or investigate evaluate if a user adopting a new artist/genre predicts their connected friends adopting the same artist."
---

# Skill: Social Contagion & Peer Influence

## Identity

- Skill key: `peer-influence-contagion`
- Group: `social-viral` (Social & Viral)
- Owning agent: `social-viral-analyst`
- Primary metric hint: `peer_influence_contagion_index`

## When To Use

Use this skill when the user selects `peer-influence-contagion` or asks for: Evaluate if a user adopting a new artist/genre predicts their connected friends adopting the same artist.
