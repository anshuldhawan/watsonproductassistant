---
name: content-screen-consumption
description: "Runs the Lighthouse Content & Screen Consumption analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `content-screen-consumption` or investigate analyze which UI screens (Home, Artist Profile, Playlist details) drive the most play events."
---

# Skill: Content & Screen Consumption

## Identity

- Skill key: `content-screen-consumption`
- Group: `engagement-patterns` (Engagement & Usage Patterns)
- Owning agent: `engagement-analyst`
- Primary metric hint: `content_screen_consumption_index`

## When To Use

Use this skill when the user selects `content-screen-consumption` or asks for: Analyze which UI screens (Home, Artist Profile, Playlist details) drive the most play events.
