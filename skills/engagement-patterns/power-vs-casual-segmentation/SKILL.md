---
name: power-vs-casual-segmentation
description: "Runs the Lighthouse Power vs. Casual User Segmentation analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `power-vs-casual-segmentation` or investigate classify users into engagement bands to analyze what triggers transition to power user status."
---

# Skill: Power vs. Casual User Segmentation

## Identity

- Skill key: `power-vs-casual-segmentation`
- Group: `engagement-patterns` (Engagement & Usage Patterns)
- Owning agent: `engagement-analyst`
- Primary metric hint: `power_vs_casual_segmentation_index`

## When To Use

Use this skill when the user selects `power-vs-casual-segmentation` or asks for: Classify users into engagement bands to analyze what triggers transition to power user status.
