...
description: "Runs the Lighthouse Session Interval (Time-Between-Sessions) analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `session-interval` or investigate measure elapsed time between consecutive listening sessions to locate friction or decay."
---

# Skill: Session Interval (Time-Between-Sessions)

## Identity

- Skill key: `session-interval`
...
Use this skill when the user selects `session-interval` or asks for: Measure elapsed time between consecutive listening sessions to locate friction or decay.
