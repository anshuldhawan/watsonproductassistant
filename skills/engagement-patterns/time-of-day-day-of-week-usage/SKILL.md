---
name: time-of-day-day-of-week-usage
description: "Runs the Lighthouse Usage by Time-of-Day & Day-of-Week analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `time-of-day-day-of-week-usage` or investigate isolate listening spikes (commutes, weekends, sleep hours) to optimize push notification delivery."
---

# Skill: Usage by Time-of-Day & Day-of-Week

## Identity

- Skill key: `time-of-day-day-of-week-usage`
...
Use this skill when the user selects `time-of-day-day-of-week-usage` or asks for: Isolate listening spikes (commutes, weekends, sleep hours) to optimize push notification delivery.
