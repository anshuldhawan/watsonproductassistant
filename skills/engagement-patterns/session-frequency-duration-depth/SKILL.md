---
name: session-frequency-duration-depth
description: "Runs the Lighthouse Session Frequency, Duration & Depth analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `session-frequency-duration-depth` or investigate detailed analysis of how often users listen, for how long, and how many tracks per session."
---

# Skill: Session Frequency, Duration & Depth

## Identity

- Skill key: `session-frequency-duration-depth`
...
Use this skill when the user selects `session-frequency-duration-depth` or asks for: Detailed analysis of how often users listen, for how long, and how many tracks per session.
