---
name: dead-end-rage-tap
description: "Runs the Lighthouse Dead-End & Rage Tap Analysis analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `dead-end-rage-tap` or investigate surface un-clickable or slow UI elements causing user frustration and quick exits."
---

# Skill: Dead-End & Rage Tap Analysis

## Identity

- Skill key: `dead-end-rage-tap`
- Group: `engagement-patterns` (Engagement & Usage Patterns)
- Owning agent: `engagement-analyst`
- Primary metric hint: `dead_end_rage_tap_index`

## When To Use

Use this skill when the user selects `dead-end-rage-tap` or asks for: Surface un-clickable or slow UI elements causing user frustration and quick exits.
