...
description: "Runs the Lighthouse DAU/WAU/MAU Stickiness analysis for Engagement & Usage Patterns. Use when the analyst is asked to run `dau-wau-mau-stickiness` or investigate track active user stickiness ratios to monitor product habituation and daily usage frequency."
---
...
- Skill key: `dau-wau-mau-stickiness`
...
Use this skill when the user selects `dau-wau-mau-stickiness` or asks for: Track active user stickiness ratios to monitor product habituation and daily usage frequency.
