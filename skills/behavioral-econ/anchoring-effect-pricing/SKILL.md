---
name: anchoring-effect-pricing
description: "Runs the Lighthouse Anchoring Effect in Plan Selection analysis for Behavioral Economics & Psychology. Use when the analyst is asked to run `anchoring-effect-pricing` or investigate examine how showcasing the Family/Duo tier impacts the checkout conversion of the Individual Premium plan."
---

# Skill: Anchoring Effect in Plan Selection

## Identity

- Skill key: `anchoring-effect-pricing`
- Group: `behavioral-econ` (Behavioral Economics & Psychology)
- Owning agent: `behavioral-econ-analyst`
- Primary metric hint: `anchoring_effect_pricing_index`

## When To Use

Use this skill when the user selects `anchoring-effect-pricing` or asks for: Examine how showcasing the Family/Duo tier impacts the checkout conversion of the Individual Premium plan.
