---
name: sunk-cost-progression
description: "Runs the Lighthouse Sunk-Cost Engagement Progression analysis for Behavioral Economics & Psychology. Use when the analyst is asked to run `sunk-cost-progression` or investigate analyze if paying an annual upfront subscription vs. monthly plans increases daily listen minutes."
---

# Skill: Sunk-Cost Engagement Progression

## Identity

- Skill key: `sunk-cost-progression`
...
Use this skill when the user selects `sunk-cost-progression` or asks for: Analyze if paying an annual upfront subscription vs. monthly plans increases daily listen minutes.
