...
description: "Runs the Lighthouse Loss Aversion & Endowment Analysis analysis for Behavioral Economics & Psychology. Use when the analyst is asked to run `loss-aversion-endowment` or investigate evaluate upgrade conversion of users who built extensive custom playlists during a free Premium trial."
---

# Skill: Loss Aversion & Endowment Analysis

## Identity

- Skill key: `loss-aversion-endowment`
- Group: `behavioral-econ` (Behavioral Economics & Psychology)
- Owning agent: `behavioral-econ-analyst`
- Primary metric hint: `loss_aversion_endowment_index`

## When To Use

Use this skill when the user selects `loss-aversion-endowment` or asks for: Evaluate upgrade conversion of users who built extensive custom playlists during a free Premium trial.
