---
name: default-nudge-effect
description: "Runs the Lighthouse Default Nudge Impact (Autoplay/Shuffle) analysis for Behavioral Economics & Psychology. Use when the analyst is asked to run `default-nudge-effect` or investigate examine how default playlist play configurations impact long-term session lengths and engagement metrics."
---

# Skill: Default Nudge Impact (Autoplay/Shuffle)

## Identity

- Skill key: `default-nudge-effect`
- Group: `behavioral-econ` (Behavioral Economics & Psychology)
- Owning agent: `behavioral-econ-analyst`
- Primary metric hint: `default_nudge_effect_index`

## When To Use

Use this skill when the user selects `default-nudge-effect` or asks for: Examine how default playlist play configurations impact long-term session lengths and engagement metrics.
