---
name: scarcity-urgency-impact
description: "Runs the Lighthouse Scarcity & Urgency Promo Performance analysis for Behavioral Economics & Psychology. Use when the analyst is asked to run `scarcity-urgency-impact` or investigate measure conversion uplift from countdown timers on holiday subscription discounts."
---

# Skill: Scarcity & Urgency Promo Performance

## Identity

- Skill key: `scarcity-urgency-impact`
- Group: `behavioral-econ` (Behavioral Economics & Psychology)
- Owning agent: `behavioral-econ-analyst`
- Primary metric hint: `scarcity_urgency_impact_index`

## When To Use

Use this skill when the user selects `scarcity-urgency-impact` or asks for: Measure conversion uplift from countdown timers on holiday subscription discounts.
